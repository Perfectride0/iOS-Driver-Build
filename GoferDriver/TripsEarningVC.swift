...
class TripsEarningVC : UIViewController, UITableViewDelegate, UITableViewDataSource
{
    @IBOutlet var imgMapRoot : UIImageView!
    @IBOutlet var imgUserThumb : UIImageView!
    @IBOutlet var tblTripsEarning : UITableView!
    ...
    {
        let cell:CellTripsInfo = tblTripsEarning.dequeueReusableCell(withIdentifier: "CellTripsInfo")! as! CellTripsInfo
        return cell
    }
