...
let sinchCallDelegateLog = OSLog(subsystem: "com.sinch.sdk.app", category: "SinchClientMediator.SinchCallDelegate")
...
//   func fanoutDelegateCall(_ callback: (_ observer: SinchClientMediatorObserver) -> Void) {
//    // Remove dangling before calling
//    self.observers.removeAll(where: { $0.observer == nil })
//    self.observers.forEach { callback($0.observer!) }
//  }
