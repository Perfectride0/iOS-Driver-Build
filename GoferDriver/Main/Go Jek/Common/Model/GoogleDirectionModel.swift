...
class GoogleGeocode: Codable {
    ...
    required init(from decoder : Decoder) throws{
        ...
        self.geocodedWaypoints = try? container.decode([GeocodedWaypoint].self, forKey: .geocodedWaypoints)
        self.routes = try? container.decode([Route].self, forKey: .geocodedWaypoints)
...
class Route: Codable {
    ...
    required init(from decoder : Decoder) throws{
        ...
        self.overviewPolyline = try? container.decode(Polyline.self, forKey: .overviewPolyline)
        self.summary = container.safeDecodeValue(forKey: .summary)
        self.warnings = try? container.decode([JSONAny].self, forKey: .warnings)
        self.waypointOrder = try? container.decode([JSONAny].self, forKey: .waypointOrder)
    }
...
class Bounds: Codable {
    ...
    required init(from decoder : Decoder) throws{
        let container = try decoder.container(keyedBy: CodingKeys.self)
        self.northeast =  try? container.decode(GoogleLocation.self, forKey: CodingKeys.northeast)
        self.southwest =  try? container.decode(GoogleLocation.self, forKey: CodingKeys.southwest)
    }
...
class Leg: Codable {
    ...
    required init(from decoder : Decoder) throws{
        ...
        self.duration = try? container.decode(Distance.self, forKey: .duration)
        self.endLocation = try? container.decode(GoogleLocation.self, forKey: .endLocation)
        self.startLocation = try? container.decode(GoogleLocation.self, forKey: .startLocation)
        ...
        self.trafficSpeedEntry = try? container.decode([JSONAny].self, forKey: .trafficSpeedEntry)
        self.viaWaypoint = try? container.decode([JSONAny].self, forKey: .viaWaypoint)
    }
...
class Step: Codable {
    ...
    required init(from decoder : Decoder) throws{
        ...
        self.endLocation = try? container.decode(GoogleLocation.self, forKey: .endLocation)
        self.startLocation = try? container.decode(GoogleLocation.self, forKey: .startLocation)
        self.polyline = try? container.decode(Polyline.self, forKey: .polyline)
