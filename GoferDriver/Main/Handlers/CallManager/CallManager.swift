...
//                self.sinchClient?
//                    .registerPushNotificationDeviceToken(data,
...
//        }else{
//            self.sinchClient?.setPushNotificationDisplayName("Driver")
//        }
//    }
//    
...
//        case .denied:
//            print(call.details.endCause)
//           
//               
//            if call.direction == .outgoing{
//                appDelegate?.createToastMessage("\(Shared.instance.storeName) \(LangCommon.busyTryAgain)")
//            }else{
//                fallthrough
//            }
//        default:
