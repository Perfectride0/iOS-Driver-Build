...
@property (nonatomic) CGFloat progressTime;
...
- (instancetype)initWithProgressView:(BIZCircularProgressView *)progressView minValue:(CGFloat)min maxValue:(CGFloat)max progressTime:(CGFloat)progressTime
{
    if (self = [super init]) {
...
- (void)ticTimer
{
    ...
    CGFloat progress = self.current / self.progressTime;
