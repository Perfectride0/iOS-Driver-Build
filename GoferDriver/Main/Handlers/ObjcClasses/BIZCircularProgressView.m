...
//    self.progressLineWidth = 2.5;
    self.progressLineWidth = 1.5;

//    self.progressLineColor = [UIColor colorWithRed: 31.0 / 255.0 green: 186.0 / 255.0 blue: 214.0 / 255.0 alpha:1.0];
//    self.progressLineColor = [UIColor colorWithRed: 234.0 / 255.0 green: 56.0 / 255.0 blue: 56.0 / 255.0 alpha:1.0];
//    self.progressLineColor = [UIColor colorNamed:@"ThemeMain"];
    
    
//    NSUserDefaults *prefs = [NSUserDefaults standardUserDefaults];
//    NSString *myString = [prefs stringForKey:@"PrimaryColor"];
//    self.themeColor = [self colorWithHexString:[NSString stringWithFormat:@"#%@",myString] alpha:1];
//    self.progressLineColor = _themeColor;
//    self.circleBackgroundColor = self.backgroundColor ? self.backgroundColor : [UIColor blueColor];
    
    self.themeColor = [self colorWithHexString:@"#f6cb2e" alpha:1];
    self.backgroundColor = [self colorWithHexString:@"#f6cb2e" alpha:0.5];
    self.progressLineColor = _themeColor;
    self.circleBackgroundColor =  self.backgroundColor ? self.backgroundColor : [UIColor blueColor];;
